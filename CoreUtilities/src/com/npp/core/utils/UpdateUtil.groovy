...
class UpdateUtil { 
	...
	private static Log log = LogFactory.getLog("com.pabslabs.core.utils.UpdateUtil")

    static boolean safeUpdateObject(Object obj, Closure updateClosure) {
    ...
    static boolean safeDeleteObject(Object obj, Closure deleteClosure) {
		String objInfo = obj.dump()
   ...
   */
  static boolean safeUpdateState(object, oldState, newState)
  {
   ...
   */
  static boolean safeUpdateState(object, oldState, newState, Closure updateClosure)
  {
