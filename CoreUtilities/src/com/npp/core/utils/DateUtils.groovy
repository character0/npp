...
class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    static Calendar getDayStartCal (Calendar inCal) {
    ...
    static Calendar getDayStartCal(Date date) {
    ...
    static Calendar getDayEndCal (Calendar inCal) {
		Calendar cal = (Calendar) inCal.clone()
	 ...
	 */
	static Date getDayStart(Calendar cal) {
	 ...
	 */
	static Date getDayEnd(Calendar cal) {
    ...
    static Calendar getMonthStartCal (Calendar inCal) {
		Calendar cal = (Calendar) inCal.clone()
        cal.set(Calendar.DAY_OF_MONTH, 1)
		return getDayStartCal(cal)
    }

    static Calendar getMonthEndCal (Calendar inCal) {
		Calendar cal = (Calendar) inCal.clone()
	 ...
	 */
	static Date getMonthStart(Calendar cal) {
	 ...
	 */
	static Date getMonthEnd(Calendar cal) {
     ...
     * @return
     */
    static Date get10MinutesBefore(Calendar inCal) {
        Calendar cal = (Calendar) inCal.clone()
     ...
     * @return
     */
    static Date get10MinutesAfter(Calendar inCal) {
        Calendar cal = (Calendar) inCal.clone()
        cal.set(Calendar.MINUTE, inCal.get(Calendar.MINUTE) + 10)
        return cal.getTime()
    }
     ...
     * @return
     */
    static Date get10MinutesBefore(Date date) {
        Calendar cal = Calendar.getInstance()
        cal.setTime(date)
     ...
     * @return
     */
    static Date get10MinutesAfter(Date date) {
        Calendar cal = Calendar.getInstance()
        cal.setTime(date)
	 ...
	 */
	static Date sameTimeTomorrow(Date day) {
	 ...
	 */
	static int compareDatesToSecond(Date date1, Date date2, int diffBuffer = 0) {
	 ...
	 */
	static Date getDateToSecond(Date date) {
		Calendar cal = Calendar.getInstance()
        cal.setTime(date)
		cal.set(Calendar.MILLISECOND, 0)
	 ...
	 */
	static Date nowTimeOnDate(Date day) {
    ...
    static Date getFirstDayPartStart(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
        cal.set(Calendar.HOUR_OF_DAY, 0)
        cal.set(Calendar.MINUTE, 0)
        cal.set(Calendar.SECOND, 0)
    ...
    static Date getFirstDayPartEnd(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getSecondDayPartStart(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getSecondDayPartEnd(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getThirdDayPartStart(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getThirdDayPartEnd(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getFourthDayPartStart(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
    ...
    static Date getFourthDayPartEnd(Calendar inCal) {
    Calendar cal = (Calendar)inCal.clone()
        cal.set(Calendar.HOUR_OF_DAY, 23)
        cal.set(Calendar.MINUTE, 59)
        cal.set(Calendar.SECOND, 59)
    ...
    static Date getFirstDayPartStart() {
		return getTodayStart()
    }

    static Date getFirstDayPartEnd() {
		Calendar cal = Calendar.getInstance()
        return getFirstDayPartEnd(cal)
    }

    static Date getSecondDayPartStart() {
		Calendar cal = Calendar.getInstance()
        return getSecondDayPartStart(cal)
    }

    static Date getSecondDayPartEnd() {
		Calendar cal = Calendar.getInstance()
        return getSecondDayPartEnd(cal)
    }

    static Date getThirdDayPartStart() {
		Calendar cal = Calendar.getInstance()
        return getThirdDayPartStart(cal)
    }

    static Date getThirdDayPartEnd() {
		Calendar cal = Calendar.getInstance()
		return getThirdDayPartEnd(cal)
    }


    static Date getFourthDayPartStart() {
		Calendar cal = Calendar.getInstance()
        return getFourthDayPartStart(cal)
    }

    static Date getFourthDayPartEnd() {
		return getTodayEnd()
    }
    ...
    static Date createDate(int year, int month, int day, int hour, int min, int sec, milliSeconds = null) {
		Calendar cal = Calendar.getInstance()
    ...
    static Date setHourOfDay(Date date, int hourOfDay) {
		Calendar cal = Calendar.getInstance()
        cal.setTime(date)
    ...
    static Date setAMPM(Date date, int am_pm) {
		Calendar cal = Calendar.getInstance()
        cal.setTime(date)
    ...
    static int getFourHourBeginBlock(Date date)
    {
     ...
     */
    static Date getDate(String dateStr, SimpleDateFormat format) {
    	Date retDate = null
     ...
     */
    static String getDateString(Date date, SimpleDateFormat format) {
    	String retStr = ""
     ...
     */
    static String[] getUSTimeZoneIds() {
     ...
     *  for given date
     */
    static String getTimeZoneAbbreviation(Date date, String timeZoneId) {
     ...
     */
    static int getTimeZoneOffsetInHours(String timeZoneId) {
     ...
     */
    static Date getDateInDefaultTimezone(Date date, String timeZoneId) {
     ...
     */
    static Date getDateInTimezone(Date date, String timeZoneId) {
    	int offset = getTimeZoneOffsetInHours(timeZoneId)
     ...
     */
    static HashMap getUSTimeZonesWithOffsets() {
     ...
     */
    static long getMillisToDayEnd(Date date) {
     ...
     */
    static Date convertTimestampToDate(Timestamp timestamp) {
	    return new Date(timestamp.getTime())
    }

    //Set time of the target date to match the source date.
    static Date setTime(Date srcDate, Date tarDate) {
	...
	static String getMonthShortName(Date date) {
    ...
    static boolean isTimeToCopyForward(Date date = new Date()) {
        return getMillisToDayEnd(date) < MILLIS_IN_HOUR
    }

    static Date getCopyForwardStartTime(Date date = new Date()) {
