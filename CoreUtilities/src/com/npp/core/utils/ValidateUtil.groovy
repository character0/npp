...
class ValidateUtil {
	...
	private static Log log = LogFactory.getLog("com.pabslabs.core.utils.ValidateUtil")
	...
	static String getInvalidChars(String str, String validChars, boolean bCanBeBlank) {
	...
	static boolean isValidString(String str, String validChars, boolean bCanBeBlank) {
	...
	static String makeValidString(String str, String validChars) {
		// Pattern to find all characters that are not (^) the valid characters
		Pattern pattern = Pattern.compile("[^" + validChars + "]*")
		Matcher matcher = pattern.matcher(str)
	...
	static String makeValidCurrency(String str) {
     ...
     * @return
     */
    static parseRevisionNumberFromScript(File scriptFile) {
